      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-4 relative">
        ...
        <div className="text-center max-w-4xl mx-auto z-10">
          ...
          <div className={`mb-12 ${isLoaded ? 'slide-up' : ''}`} style={{ animationDelay: '0.6s' }}>
            ...
            <p className="text-xl md:text-lg lg:text-lg text-white  leading-relaxed mb-2 font-light">
            All i couldn't say is here in these letters. 💌
            </p>
          </div>
...
//       <div className="text-center max-w-4xl mx-auto z-10">
//         <div className={`mb-5 ${isLoaded ? 'slide-up' : ''}`} style={{ animationDelay: '0.3s' }}>
//           <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-[#4e342e] mb-6 leading-tight">
//             helluu Mohit
//           </h1>
//           <div className="w-24 h-1 bg-[#4e342e] mx-auto rounded-full mb-4"></div>
//         </div>

//         <div className={`mb-12 ${isLoaded ? 'slide-up' : ''}`} style={{ animationDelay: '0.6s' }}>
//           <p className="text-xl md:text-lg lg:text-lg text-[#4e342e] leading-relaxed mb-2 font-light">
//             Hello my YOU, i know you're strong but even a strong person like you deserves rest.<br /> 
//             So these are pieces of my light, kept safe for you. Whenever you need just open a letter. 🫀
//           </p>
//           <p className="text-xl md:text-lg lg:text-lg text-[#4e342e] leading-relaxed mb-2 font-light">
//             No matter what happens My Love and Prayers stay right by your side🫶
//           </p>
...
//           <button
//             onClick={onNavigateToLetters}
//             className="glow-button pulse-glow px-8 py-4 md:px-12 md:py-6 rounded-full text-[#efebe9] font-bold text-lg md:text-xl flex items-center gap-3 mx-auto hover:scale-105 transform transition-all duration-300"
//           >
//             <Heart className="w-6 h-6" fill="currentColor" />
//             Open Letters
//             <Heart className="w-6 h-6" fill="currentColor" />
...
//       {/* Decorative Elements */}
//       <div className="absolute top-20 left-10 text-[#bcaaa4] text-4xl opacity-60 floating-heart">
//         💕
//       </div>
//       <div className="absolute top-32 right-16 text-[#a1887f] text-3xl opacity-50 floating-heart">
//         🌸
//       </div>
//       <div className="absolute bottom-32 left-20 text-[#bcaaa4] text-5xl opacity-40 floating-heart">
//         ✨
//       </div>
//       <div className="absolute bottom-40 right-12 text-[#a1887f] text-4xl opacity-60 floating-heart">
//         💗
//       </div>
//       <div className="absolute top-1/2 left-4 text-[#bcaaa4] text-3xl opacity-50 floating-heart">
//         🦋
//       </div>
//       <div className="absolute top-1/3 right-8 text-[#a1887f] text-6xl opacity-30 floating-heart">
//         🤍
//       </div>
//     </div>
//   );
