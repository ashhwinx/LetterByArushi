  ...
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
      {hearts.map((heart) => (
        <div
          key={heart.id}
          className="absolute opacity-20 text-[#bcaaa4]"
          style={{
            left: `${heart.left}%`,
            fontSize: `${heart.size}px`,
            animation: `float ${heart.animationDuration}s ease-in-out infinite`,
      ...
      {/* Additional floating elements */}
      <div className="absolute top-1/4 left-1/4 opacity-10 text-6xl text-[#a1887f] floating-heart">
        🌸
      </div>
      <div className="absolute top-3/4 right-1/4 opacity-10 text-5xl text-[#bcaaa4] floating-heart">
        ✨
      </div>
      <div className="absolute top-1/2 left-1/6 opacity-10 text-4xl text-[#a1887f] floating-heart">
        🦋
      </div>
      <div className="absolute bottom-1/4 right-1/3 opacity-10 text-7xl text-[#bcaaa4] floating-heart">
        💕
      </div>
    </div>
  );
